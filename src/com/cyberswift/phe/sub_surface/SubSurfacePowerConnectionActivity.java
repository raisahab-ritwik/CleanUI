...
public class SubSurfacePowerConnectionActivity extends BaseActivity implements OnCheckedChangeListener, OnClickListener, ServerResponseCallback,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContext = SubSurfacePowerConnectionActivity.this;
		initView();
	...
	private void checkingLocation() {
		...
		if (!isGooglePlayServicesAvailable()) {
			...
			Dialog dialog = GooglePlayServicesUtil.getErrorDialog(status, SubSurfacePowerConnectionActivity.this, requestCode);
			dialog.show();
		} else {
	...
	protected void onDestroy() {
		...
		Util.trimCache(SubSurfacePowerConnectionActivity.this);
	}
