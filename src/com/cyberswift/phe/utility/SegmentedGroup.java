...
public class SegmentedGroup extends RadioGroup {
	...
	private void initAttrs(AttributeSet attrs) {
		...
		try {
			...
			mCornerRadius = typedArray.getDimension(R.styleable.SegmentedGroup_sc_corner_radius, getResources()
	...
	private class LayoutSelector {
		...
		private final float r1 = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 0.1f, getResources().getDisplayMetrics()); // 0.1
																																	// dp
																																	// to
																																	// px
